                ...
                <!-- Area Chart -->
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div
                            ...
                            <h6 class="m-0 font-weight-bold text-primary">Bình luận gầy đây</h6>
                        ...
                        <div class="card-body">
                            <div v-for="(comment,index) in comments" :key="comment._id">
                                <div class="row mb-2" v-if="format_date(comment.createAt) > date">
                                    ...
                                    <div class="col-2">
                                        <span class="text-success" v-if="comment.isPost==true">Duyệt</span>
                                        <span class="text-danger" v-else>Đang xét</span>
                                    </div>
                                </div>
