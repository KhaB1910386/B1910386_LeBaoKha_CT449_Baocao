<template>
  ...
  <div class="btn-group">
    ...
    <ul class="dropdown-menu">
      <li class="list dropdown-item" :class=" {'active_topic': (activeId === 'monday')}" @click="filterArray('monday')">Thứ hai</li>
      <li class="list dropdown-item" :class=" {'active_topic': (activeId === 'tuesday')}" @click="filterArray('tuesday')">Thứ ba</li>
  ...
  <section class="section">
    <ul class="nav">
      <li class="nav-item list" :class=" {'active_topic': (activeId === 'monday')}" @click="filterArray('monday')">Thứ hai</li>
      <li class="nav-item list" :class=" {'active_topic': (activeId === 'tuesday')}" @click="filterArray('tuesday')">Thứ ba</li>
      <li class="nav-item list" :class=" {'active_topic': (activeId === 'wednesday')}" @click="filterArray('wednesday')">Thứ tư</li>
      <li class="nav-item list" :class=" {'active_topic': (activeId === 'thursday')}" @click="filterArray('thursday')">Thứ năm</li>
      <li class="nav-item list" :class=" {'active_topic': (activeId === 'friday')}" @click="filterArray('friday')">Thứ sáu</li>
      <li class="nav-item list" :class=" {'active_topic': (activeId === 'saturday')}" @click="filterArray('saturday')">Thứ bảy</li>
      <li class="nav-item list" :class=" {'active_topic': (activeId === 'sunday')}" @click="filterArray('sunday')">Chủ nhật</li>
    </ul>
  </section>
  <div class="comic">
    <!-- row1 -->
