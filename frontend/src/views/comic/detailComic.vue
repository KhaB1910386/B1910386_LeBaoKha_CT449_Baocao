        ...
        <div class="container detail" style="margin-top: 40px;">
            <div class="row m-3 p-4">
              ...
              <div class="col-7">
                    ...
                    <div class="mb-3 text-white">Tác giả: <span class="title-detail">{{ comic.actor }}</span></div>
                    <div class="mb-3 text-white">Thể loại: <span class="title-detail">{{ genreName }}</span></div>
                    <div class="mb-3 text-white">Chương:</div>
                    <div class="row mb-3">
                        <router-link v-for="(content,index) in contents" :key="content._id" class="text-white col-12 mb-2 chapter" :to="{
                            ...
                            <i class="fa-solid fa-play mx-1"></i> Chương {{ index+1 }} : {{ content.nameContent }}
                        </router-link>
                    </div>
            ...
            <div class="mt-5">
                <h3 class="text-white text-center">Đề xuất</h3>
                <swiper
                    :effect="'coverflow'"
                    :grabCursor="true"
                    :centeredSlides="true"
