        ...
        <div class="container inner_header">
            <div class="left_header">
                ...
                <nav>
                    <ul class="main_menu">
                        <li>
                            <router-link to="/" class="items_menu">Trang chủ</router-link>
                        </li>
                        
                        <li>
                            <router-link to="/genre" class="items_menu">Thể loại</router-link>
                        </li>
                        <li>
                            <router-link to="/trending" class="items_menu">Thịnh hành</router-link>
                        </li>
                    </ul>
                </nav>
            </div>
            <div class="right_header">
                ...
                <div>
                    <form class="search_box me-3" action="/search">
                        <input type="search" :value="this.$route.query.search" name="search" class="search_text" placeholder="Tìm kiếm nội dung" required>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="text-center">
                                    <h5 class="m-0" style="font-weight: 600; color: #555555;">Đăng ký   </h5>
                                    <p class="m-0 p-0" style="color:#666666">Vui lòng đăng ký tài khoản</p>
                                </div>
                                <RegisterForm  
                                    :user="user"
                ...
                <div class="modal fade" id="exampleModal1" tabindex="-1" aria-labelledby="exampleModal1Label" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="text-center">
                                    <h5 class="m-0" style="font-weight: 600; color: #555555;">Đăng nhập</h5>
                                </div>
                                <LoginForm 
                                    :user="user"
                                    @submit:user="Login" 
